...
final class StandardWrapperValve extends ValveBase {
    ...
    public final void invoke(Request request, Response response)
        ...
        // Create the filter chain for this request  给当前请求创建一个 Filter 链
        /**
         * 为什么需要给每个请求创建一个 Filter 链？
         * 这是因为每个请求的请求路径都不一样，而 Filter 都有相应的路径映射，因此不是所有的 Filter 都需要来处理当前的请求，
         * 我们需要根据请求的路径来选择特定的一些 Filter 来处理
         */
        ApplicationFilterChain filterChain =
                ApplicationFilterFactory.createFilterChain(request, wrapper, servlet);

        // Call the filter chain for this request
        // NOTE: This also calls the servlet's service() method  filter执行完成后调用servlet的service方法
            ...
            if ((servlet != null) && (filterChain != null)) {
                ...
                if (context.getSwallowOutput()) {
                    ...
                    if (request.isAsyncDispatching()) {
                        ...
                        // 调用这个 Filter 链，Filter 链中的最后一个 Filter 会调用 Servlet
