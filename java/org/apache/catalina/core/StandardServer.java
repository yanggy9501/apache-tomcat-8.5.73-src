...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    /**
     * The port number on which we wait for shutdown commands. 监听 shutdown请求
     */
    ...
    public void await() {
        ...
        // Set up a server socket to wait on 在8005端口监听shutdown
        try {
    ...
    protected void startInternal() throws LifecycleException {
        ...
        // Start our defined Services 启动子组件 Service
        synchronized (servicesLock) {
            for (Service service : services) {
                service.start();
            }
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // class loaders
        if (getCatalina() != null) {
            ClassLoader cl = getCatalina().getParentClassLoader();// shared ClassLoader
        ...
        // Initialize our defined Services  初始化子容器 Service组件
        for (Service service : services) {
            service.init();
        }
    }
