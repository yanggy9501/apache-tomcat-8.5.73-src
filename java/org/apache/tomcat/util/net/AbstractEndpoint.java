...
public abstract class AbstractEndpoint<S> {
    ...
    /**
     * Cache for SocketProcessor objects 缓存 SocketProcessor对象
     */
    ...
    /**
     * External Executor based thread pool. 类似是业务线程池
     */
    ...
    public void createExecutor() {
        ...
        /**
         * tomcat 定制的任务队列
         * 1、基于 LinkedBlockingQueue (无界的,除非指定capacity)
         * 2、重写了 LinkedBlockingQueue 的 offer,解决无界等待队列不能及时创建新线程造成请求积压的问题
         */
        TaskQueue taskqueue = new TaskQueue();
        TaskThreadFactory tf = new TaskThreadFactory(getName() + "-exec-", daemon, getThreadPriority());
        /**
         * ThreadPoolExecutor: 基于JDK线程池的改造
         * 工作线程池默认:
         *  core threads:10
         *  max threads:200
         *
